...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionOpenFolder.triggered.connect(MainWindow.openFileDialog)
        self.treeView.clicked['QModelIndex'].connect(MainWindow.songSelected)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.treeWidget.topLevelItem(0).child(0).child(0).child(1).setText(0, _translate("MainWindow", "New Item"))
        self.treeWidget.topLevelItem(0).child(0).child(0).child(2).setText(0, _translate("MainWindow", "New Item"))
        self.treeWidget.topLevelItem(0).child(0).child(0).child(3).setText(0, _translate("MainWindow", "New Item"))
